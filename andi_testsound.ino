 ...
 * ANDI
 *
 * This code is written as a part of a school project at 
 * LTH in Lund, Sweden, in the spring of 2017.
 * This code works as a beat generator and it is a part of a 
 * project which is a conversation between an ANalog outside
 * of a product and a DIgital heart that resides inside.
 * This product, the first generation of ANDI, was produced in 
 * 10 units and was made possible by the open minded android community.
 * I want to dedicate this code to everyone who shared their libraries of
 * code online with helpful instructions for a beginner like me.
 * 
 * Thank you, and please follow the ANDI project online at:
 * http://www.andinstruments.com
 * 
 * Best regards,
 * Ola Andrén - ANDI Creator
 * May 31 2017
 */
